! function(t) {
    ...
    e.prototype.init = function() {
        ...
        }), t("#sa-image").click(function() { Swal.fire({ title: "UBold", text: "Responsive Bootstrap 4 Admin Dashboard", imageUrl: "../assets/images/logo-sm.png", imageHeight: 50, animation: !1, confirmButtonClass: "btn btn-confirm mt-2" }) }), t("#sa-close").click(function() {
            var t;
            Swal.fire({
            ...
            Swal.fire({
                ...
                preConfirm: function(t) {
                    return fetch("//api.github.com/users/" + t).then(function(t) {
                        ...
                        return t.json()
                    }).catch(function(t) { Swal.showValidationMessage("Request failed: " + t) })
                },
                allowOutsideClick: function() { Swal.isLoading() }
            }).then(function(t) { t.value && Swal.fire({ title: t.value.login + "'s avatar", imageUrl: t.value.avatar_url }) })
