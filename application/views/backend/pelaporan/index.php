<div class="content-page">
                ...
                <table id="basic-datatable" class="table wy-table-responsive w-100">
                  ...
                  <tbody>
                    ...
                    foreach ($data_laporan as $laporan) : ?>
                      <tr>
                        <td>
                          <a href="<?= base_url('backend/pelaporan/hapus/') . $laporan['id'] ?>" class="badge badge-danger hapus"><i class="fe-trash" title="Hapus"></i></a> <br>
                          <a href="<?= base_url('backend/pelaporan/detail/') . $laporan['nama_pelapor'] ?>" class="badge badge-success"><i class="fe-eye" title="Detail"></i></a>
                        </td>
                        <td><?= $no++; ?></td>
                        <td><?= $laporan['nama'] ?></td>
                        ...
                        <td class="text-center">
                          <?php if ($laporan['status'] == "MENUNGGU") : ?>
                            <a href="" class="badge badge-warning" data-target="#modal-update<?= $laporan['id'] ?>" data-toggle="modal">MENUNGGU</a>
                          <?php elseif ($laporan['status'] == "DIPROSES") : ?>
                            <a href="" class="badge badge-info" data-target="#modal-update<?= $laporan['id'] ?>" data-toggle="modal">DIPROSES</a>
  ...
  <div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      ...
      <form action="<?= base_url('backend/pelaporan') ?>" class="parsley-examples" method="POST" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="no_kk" value="<?= set_value('no_kk') ?>" parsley-trigger="change" required placeholder="Enter tipe user" class="form-control" id="no_kk">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="no_ktp" value="<?= set_value('no_ktp') ?>" parsley-trigger="change" required placeholder="Enter tipe user" class="form-control" id="no_ktp">
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <input type="number" name="no_ken" value="<?= set_value('no_ken') ?>" parsley-trigger="change" required placeholder="Enter nomor kendaraan" class="form-control" id="no_ken">
            </div>
              ...
              <div class="col-md-6">
                <div class="form-input">
                  ...
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="stnk" name="stnk" parsley-trigger="change" required>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="latitude" id="latitude" class="form-control" placeholder="Enter latitude" parsley-trigger="change" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="longitude" id="longitude" class="form-control" placeholder="Enter longitude" parsley-trigger="change" required>
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" parsley-trigger="change" required></textarea>
            </div>
  ...
  <?php foreach ($data_laporan as $update) : ?>
    <div id="modal-update<?= $update['id'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
