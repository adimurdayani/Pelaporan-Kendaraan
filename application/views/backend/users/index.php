<div class="content-page">
            ...
            <span aria-hidden="true">&times;</span>
              ...
              <div class="table-responsive">
                <table id="basic-datatable" class="table wy-table-responsive w-100">
                  ...
                  <tbody>
                    <?php $no = 1; foreach($get_users as $data):?>
                    <tr>
                      <td>
                        <a href="<?= base_url('backend/users/hapus/') . $data['id']?>"
                      ...
                      <td class="text-center">
                        ...
                        <a href="" data-target="#modal-update<?= $data['id'];?>" data-toggle="modal"><i
                            class="fe-check-square" style="color: green;"></i></a>
                        <?php endif;?>
                      </td>
                      <td class="text-center">
                        <?php if($data['user_active'] == 0):?>
                        <a href="" data-target="#modal-update<?= $data['id'];?>" data-toggle="modal"><i
                            class="fe-x-square" style="color: red;"></i></a>
                        <?php endif;?>
                      </td>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" value="<?= set_value('nama')?>" required placeholder="Enter nama"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="username" value="<?= set_value('username')?>" placeholder="Enter username"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="password" name="password" value="<?= set_value('password')?>"
                    placeholder="Enter password" class="form-control" id="pass2" data-parsley-minlength="6" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="password" name="konf_pass" value="<?= set_value('konf_pass')?>"
                    data-parsley-equalto="#pass2" data-parsley-minlength="6" placeholder="Konfirmasi password"
                    class="form-control" id="konf_pass" required>
                </div>
              </div>
  ...
  <div id="modal-update<?= $user['id']?>" class="modal fade" tabindex="-1" role="dialog"
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="nama">Nama<span class="text-danger">*</span></label>
                  <input type="text" name="nama" value="<?= $user['nama']?>" placeholder="Enter nama" required readonly
                    class="form-control" id="nama">
            ...
            <div class="form-group">
              <label for="email">Email<span class="text-danger">*</span></label>
              <input type="email" name="email" value="<?= $user['email']?>" required placeholder="Enter email" readonly
                class="form-control" id="email">
              <?= form_error('email', '<small class="text-danger">', '</small>')?>
            </div>

            <div class="form-check">
              <input type="checkbox" name="user_active" <?php if($user['user_active'] == 1):?> checked
                class="form-check-input" value="<?= $user['user_active']?>" <?php else:?> <?php endif;?> value="1">
