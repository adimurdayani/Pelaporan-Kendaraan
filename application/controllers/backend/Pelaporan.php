...
class Pelaporan extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->form_validation->set_rules('no_ktp', 'Nomor KTP', 'trim|required|min_length[5]|max_length[16]');
    $this->form_validation->set_rules('no_kk', 'Nomor KTP', 'trim|required|min_length[5]|max_length[16]');
